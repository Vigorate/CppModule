...
/*   Updated: 2022/02/15 19:49:59 by ambelkac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ScavTrap::guardGate(void)
{
	if (this->_energypoint > 0 && this->_hitpoint > 0)
	{
		...
		std::cout << "ScavTrap " << this->getName() << " does not have enough energy points." << std::endl;
	else if (this->_hitpoint == 0)
		std::cout << "ScavTrap " << this->getName() << " does not have enough hit points." << std::endl;
